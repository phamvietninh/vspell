...
Đối với tiếng Anh, bước này dùng thuật toán như doublephone, Soundex \cite{soundex},
...
\item Duyệt lần lượt các nút $W$ theo thứ tự từ trái sang phải, tính
  ...
  Với mỗi $W$ tìm được, cộng thêm $p(W)$ vào $P^{left}(W')\quad
  W' \in R(W)$
\end{enumerate}
...
\item Duyệt tất cả các nút $W$ từ phải sang trái, tính theo vị trí kết
  ...
  \begin{enumerate}
  \item Với mỗi $W$ tìm được, cộng thêm $p(W)$ vào
    $P^{right}(W')\quad W' \in L(W)$
...
N-gram được tính như thông thường. Sử dụng backoff chuẩn.
