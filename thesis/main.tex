...
\paragraph{Thuật toán khử nhập nhằng dựa trên CD}

Cho cửa sổ với kích thước nhất định, chương trình di chuyển cửa sổ mỗi
...
\subsection{Áp dụng HMM}


\subsection{Áp dụng WFST}



\subsection{Áp dụng TBL}


\subsection{Áp dụng mô hình Source-Channel cải tiến}
