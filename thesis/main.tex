...
con của token đó trong câu thật sự.
...
Lưới từ \verb@Lattice@ không có nút head và tail, cũng không có các
...
trong WordEntries --- tạm gọi là WordID.

Lưới từ \verb@DAG@ được dùng để tổng quát hoá các thuật toán hoạt động
trên cả lưới từ và lưới~2-từ. Lớp dẫn xuất \verb@WordDAG@ hoạt động
như lưới từ cơ bản, còn lớp \verb@WordDAG2@ hoặt động như lưới~2-từ.
